...
public:
    ...
    void setEditMode(bool enabled, bool isDesktopMode, bool initialized);
    void toggleEditMode(bool isDesktopMode, bool initialized);
    void applyWindowFlags(bool isDesktopMode, bool initialized);
